    ...
    <div class="content flex justify-between">
      <div class="header__logo">
        <nuxt-link :to="`/${lang}`" class="header__logo-link">
          <img :src="this.$config.axios.logo ? this.$config.axios.logo : '/img/w-logo.png'" class="logo-desc" alt="logo" />
          <img :src="this.$config.axios.logo ? this.$config.axios.logo : '/img/w-logo.png'" class="logo-mob" alt="logo" />
        </nuxt-link>
      </div>
      <div class="header__etc flex justify-between flex-no-wrap">
        ...
        <div class="header__menu" @click.stop="togglePageMenu">
          ...
          <ul class="navigation" :class="{ navigation__open: isMenuActivated.page }">
            ...
            <li class="navigation__item">
              <a href="/account/buy" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('buy_sell') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/card" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('card') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/trading_comp" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('trading_comp') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/token-listing" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('token_listing') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/ieo" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('ieo') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/market-making" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('market_making') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/aml" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('a_k_policy') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/lending" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('lending') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/borrowing" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('borrowing') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/staking" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('staking') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/nodes" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('nodes') }}
              </a>
            </li>
            <li class="navigation__item">
              <a href="/account/launchpad" class="navigation__link">
                <img class="navigation__link__img" width="20" height="20" src="/public/img/menu/list-ul.svg">
                {{ $t('launchpad') }}
              </a>
            </li>
