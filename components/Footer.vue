    ...
    <div class="content">
      <div class="footer-content-wrapper">
        <div class="footer-copy">
          <div class="copyright">
            {{ new Date().getFullYear() }} © {{ this.$config.axios.title }} Yasuke Crypto Exchange
          </div>
        ...
        <div class="footer-links">
          <div class="footer-links-column">
            ...
            <a href="/account/buy">{{ $t('buy_sell') }}</a>
            <a href="/account/card">{{ $t('card') }}</a>
            <a href="/account/trading-comp">{{ $t('trading_comp') }}</a>
            <a href="/account/token-listing">{{ $t('token_listing') }}</a>
            <a href="/account/ieo">{{ $t('ieo') }}</a>
            <a href="/account/market-making">{{ $t('market_making') }}</a>
            <a href="/account/aml">{{ $t('a_k_policy') }}</a>
          </div>
          <div class="footer-links-column">
            <div class="footer-links-title">
              {{ $t('information') }}
            </div>
            <a href="/account/about">{{ $t('about') }}</a>
            <a href="/account/support">{{ $t('support') }}</a>
            <a href="/account/about">{{ $t('about') }}</a>
            <a href="/account/fees">{{ $t('feeAndLimits') }}</a>
            <a href="/account/roadmap">{{ $t('roadmap') }}</a>
          ...
          <div class="footer-links-column">
            ...
            <a href="/account/lending">{{ $t('lending') }}</a>
            <a href="/account/barrowing">{{ $t('barrowing') }}</a>
            <a href="/account/staking">{{ $t('Staking') }}</a>
            <a href="/account/nodes">{{ $t('nodes') }}</a>
            <a href="/account/launchpad">{{ $t('launchpad') }}</a>
          </div>
        </div>
